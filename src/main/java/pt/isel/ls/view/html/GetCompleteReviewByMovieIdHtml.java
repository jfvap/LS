...
public class GetCompleteReviewByMovieIdHtml extends OverviewHtml {
    ...
    private Element getHtmlHeaders(CompleteReview review) {
        ...
        return new Element(
                ...
                +
                anchor(
                        "Go to reviews movie" + review.movie.title,
                        class__,
                        "/movies/" + review.movie.id + "/reviews",
                        new Element("Reviews Movie " + review.movie.title)
                )
        );
    }
